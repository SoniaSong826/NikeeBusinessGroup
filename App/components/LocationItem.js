...
function LocationItem({ image, title, address1, address2, tel, showTel, emailLink }) {
	const telephone = {
		number: tel,
		prompt: false,
	};
		...
		<View style={styles.container}>
			...
			<View style={styles.textContainer}>
				...
				<View style={styles.buttonContainer}>
					<TouchableOpacity style={styles.buttonBorder} onPress={() => call(telephone).catch(console.error)}>

...
import { ImageBackground, ScrollView, StyleSheet, Alert, View } from 'react-native';
import * as Yup from 'yup';
import { AppForm, SubmitButton, AppFormFieldWithTitle, KeyboardAvoidingView, ErrorMessage } from '../components/form';
...
const validationSchema = Yup.object().shape({
	...
	country: Yup.string().required().label('This'),
});
...
function CareerScreen(props) {
	...
	return (
		<ImageBackground style={styles.backGround} source={require('../assets/lightGreen_background.jpg')}>
				...
				<ScrollView contentContainerStyle={styles.form}>
					...
					>
						...
						<AppFormFieldWithTitle
							...
							multiline
						/>
						<AppFormFieldWithTitle name="motivations" title="What motivates you?" multiline />
						<AppFormFieldWithTitle
							name="involvement"

			...
			<ImageBackground style={styles.backGround} source={require('../assets/inner-background.png')}>
				<ScrollView style={styles.container}>
					...
					<AppText style={styles.introduction}>
						International students are a crucial part of Australia’s economy and tourism sector.In recent
						years we have had over 899,000 students enroll in education programs across Australia with over
						350,000enrolled in Higher Education studies in the last year alone.{'\n'}
						{'\n'}With a substantial economic benefit to the Australian economy, no doubt Australia loves
						opening its doors to international students every year.{'\n'}
						{'\n'}After coal and iron ore, international education is Australia’s third biggest export
						industry.International students seeking permanent residence apply under the Australian skilled
						migration program.{'\n'}
						{'\n'}Over the past five years former students have made up between six and nine per cent of the
						family streamand between 14 and 22 per cent of the skill stream.Nikee Education Advisors
						provides students with educational enrolment support, visa advice and on-one-ontailored
						consultations to solve all your problems in Australia.
					</AppText>
					<Image
						style={styles.pic}
						source={require('../assets/educationPicture/service_education.jpg')}
					></Image>
